...
const Footer = () => {
    return (
        <>
            <footer className="footer justify-around p-10 bg-gray-900 text-white">
                <nav>
                    <header className="footer-title">Services</header>
                    <a className="link link-hover">Desserts</a>
                    <a className="link link-hover">Pasta</a>
                    <a className="link link-hover">Vagetable</a>
                    <a className="link link-hover">Korean Food</a>
                </nav>
                <nav>
            ...
            <footer className="footer bg-gray-900 text-white px-10 py-4 border-t  border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Food And Beverage <br />Copyright  2023 Md Helal Uddin.</p>
                </aside>
